...
class Map:
    ...
    """
    def __init__(self, burning_dict=None, flammability_dict=None, weather=None):
        """
...
class Flammability:
    ...
    def __init__(self, value=0):
        """
        Assigns a number between 0 and 100 to represent the flammability of an area
        """
        self.flammability = value
